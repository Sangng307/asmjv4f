<footer class="tm-bg-gray pt-5 pb-3 tm-text-gray tm-footer mb-5">
...
$(document).ready(function() {
	$('#changePassBtn').click(function() {
				...
				$.ajax({
					...
					$('#messageChangePass').text('Da doi mat khau');
				}).fail(
						function(error) {
							$('#messageChangePass').text(
									'Mat khau khong chinh xac xin thu lai');
						});
			});
});
</script>
...
$(document).ready(function() {
	$('#btnEdit').click(function() {
				...
				$.ajax({
					...
					$('#messageEdit').text('Da doi thong tin!');
				}).fail(
						function(error) {
							$('#messageEdit').text(
									'Mat khau khong chinh xac xin thu lai');
