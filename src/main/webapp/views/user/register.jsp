...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        	...
        	<div class="col-lg-12 col-12 mb-5">
                ...
                <h2 class="tm-text-primary text-center mb-5">Register Page</h2>
                    ...
                    <div class="form-group">
                        <input type="password" name="cfmpassword" class="form-control rounded-0" placeholder="Comfirm Password" required />
                    </div>
